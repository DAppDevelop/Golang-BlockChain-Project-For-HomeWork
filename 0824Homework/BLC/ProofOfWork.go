...
func (pow *ProofOfWorkYS) prepareDataYS() []byte {
	...
	data := bytes.Join([][]byte{ //[]byte的切片
		...
		pow.BlockYS.HashTransactionsYS(),
		IntToHex(pow.BlockYS.TimestampYS),
		IntToHex(int64(targetBit)),
		IntToHex(int64(pow.BlockYS.HeightYS)),
	}, []byte{},
	)
...
func (pow *ProofOfWorkYS) IsValidYS() bool {
	...
	hashInt.SetBytes(pow.BlockYS.HashYS)
